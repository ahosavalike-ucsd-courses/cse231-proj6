...
success_tests! {
	...
	},
	{
		...
		input: "1",
		heap_size: 20,
		expected: "(list (list nil 1 nil) 0 (list nil -1 nil))",
	},
	{
		name: bst_invert_86,
		file: "bst_invert.snek",
		input: "3",
		heap_size: 40,
		expected: "(list (list (list (list nil 3 nil) -2 nil) 1 nil) 0 (list nil -1 (list nil 2 (list nil -3 nil))))",
	},
	{
		name: bst_invert_88,
		file: "bst_invert.snek",
		input: "10",
		heap_size: 110,
		expected: "(list (list (list (list (list (list (list (list (list (list (list nil 10 nil) -9 nil) 8 nil) -7 nil) 6 nil) -5 nil) 4 nil) -3 nil) 2 nil) -1 nil) 0 (list nil 1 (list nil -2 (list nil 3 (list nil -4 (list nil 5 (list nil -6 (list nil 7 (list nil -8 (list nil 9 (list nil -10 nil)))))))))))",
	},
	{
